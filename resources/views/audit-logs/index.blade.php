    ...
    <div class="overflow-x-auto">
        <table class="erp-table min-w-full text-sm">
            <thead class="bg-slate-50/80"><tr>
                <th>Time</th><th>User</th><th>Action</th><th>Document</th><th>Remarks</th>
            </tr></thead>
            <tbody>
                ...
                @empty
                    <tr><td colspan="5"><x-ui.empty-state title="No audit log entries" /></td></tr>
                @endforelse
            </tbody>
        </table>
    </div>

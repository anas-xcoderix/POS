@php $title = 'Stock Transfers'; @endphp
<x-erp-layout>
<div class="erp-card overflow-hidden">
    <div class="flex flex-col gap-4 border-b border-slate-100 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
        <form method="GET" class="relative flex-1 sm:max-w-sm">
            ...
            <input type="text" name="search" value="{{ $search }}" placeholder="Search transfer no..." class="erp-input !mt-0 pl-10">
        </form>
    ...
    <div class="overflow-x-auto">
        <table class="erp-table min-w-full">
            <thead class="bg-slate-50/80"><tr>
                <th>Transfer No</th><th>From</th><th>To</th><th>Date</th><th>Status</th><th class="text-right">Action</th>
            </tr></thead>
            <tbody>
                ...
                @empty
                    <tr><td colspan="6">
                        <x-ui.empty-state title="No stock transfers" description="Move stock between branches and locations.">

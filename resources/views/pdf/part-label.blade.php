...
<head>
    <meta charset="utf-8">
    <title>Label {{ $part->part_number }}</title>
    <style>
        body { font-family: DejaVu Sans, sans-serif; text-align: center; padding: 12px; }
        .label { border: 1px dashed #94a3b8; padding: 16px; width: 280px; margin: 0 auto; }
        .part-no { font-size: 16px; font-weight: bold; margin-bottom: 4px; }
        .desc { font-size: 10px; color: #64748b; margin-bottom: 8px; }
        .barcode img { max-width: 100%; height: 50px; }
        .code { font-size: 11px; letter-spacing: 1px; margin-top: 4px; }

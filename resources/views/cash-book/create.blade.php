@php $title = 'New Cash Book Entry'; @endphp
<x-erp-layout>
<form method="POST" action="{{ route('cash-book.store') }}" class="erp-card max-w-2xl p-6 space-y-4">
    ...
    <x-ui.form-field label="Type" name="entry_type" type="select" required>
    ...
    <x-ui.form-field label="Amount" name="amount" type="number" step="0.01" required />
    ...
    <div class="flex gap-3 justify-end">
        <a href="{{ route('cash-book.index') }}" class="erp-btn-secondary">Cancel</a>

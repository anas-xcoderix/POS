@php $title = __('modules.new_purchase_invoice'); @endphp
<x-erp-layout>
<form method="POST" action="{{ route('purchase-invoices.store') }}" class="space-y-6">
    @csrf
    <div class="erp-card p-6">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <x-ui.form-field label="Status" name="status" type="select" hint="Posted will receive stock into locations">
                <option value="draft">Draft</option><option value="posted">Posted — receive stock</option>
            </x-ui.form-field>
        </div>
    </div>
